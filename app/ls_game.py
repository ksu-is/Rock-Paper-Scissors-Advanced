...
def random_choice(options=["rock", "paper", "scissors","lizard","spock"]):
...
if __name__ == "__main__":
    ...
    user_choice = input("Please choose either 'rock', 'paper','scissors', 'lizard', or 'spock': ")
